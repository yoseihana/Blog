...
$GLOBALS['validEntities'] = array('article' => 'article', 'commentaire' => 'commentaire', 'categorie' => 'categorie', 'membre' => 'membre', 'error' => 'error');
...
define('DEFAULT_CONTROLLER', $GLOBALS['validEntities']['article']); // utilisation lorsqu'on vient sur l'application et qu'il n'y a pas de param, par défaut on affiche la liste des livres. Ici livre
